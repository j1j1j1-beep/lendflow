          ...
          <FadeIn>
            <div className="max-w-3xl">
              ...
              <p className="mt-8 text-lg text-muted-foreground sm:text-xl max-w-2xl leading-relaxed">
                OpenShut generates complete legal document packages for
                lending, fund formation, M&A, real estate syndication, and
                fund compliance. Enter the deal terms, upload financials, and
                get back every document your deal requires. Every number is
                calculated, not generated by AI.
              </p>
