...
const STATUS_CONFIG: Record<string, { percent: number; label: string }> = {
  UPLOADED: { percent: 5, label: "Preparing your documents..." },
  PROCESSING_OCR: { percent: 15, label: "Reading your documents..." },
  CLASSIFYING: { percent: 30, label: "Analyzing your documents..." },
  EXTRACTING: { percent: 45, label: "Analyzing your documents..." },
  VERIFYING: { percent: 60, label: "Verifying data..." },
  RESOLVING: { percent: 68, label: "Verifying data..." },
  ANALYZING: { percent: 78, label: "Running financial analysis..." },
  STRUCTURING: { percent: 88, label: "Structuring deal terms..." },
  GENERATING_DOCS: { percent: 94, label: "Generating your documents..." },
  GENERATING_MEMO: { percent: 98, label: "Finalizing..." },
  COMPLETE: { percent: 100, label: "Your documents are ready" },
  NEEDS_REVIEW: { percent: -1, label: "Waiting for your review" },
  NEEDS_TERM_REVIEW: { percent: -1, label: "Waiting for your review" },
  ERROR: { percent: -1, label: "Something went wrong" },
};
