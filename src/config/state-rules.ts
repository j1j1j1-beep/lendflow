...
const STATE_RULES_MAP: Record<string, StateRule> = {
  ...
  GA: { state: "Georgia", abbreviation: "GA", maxInterestRate: 999, commercialExemption: true, commercialExemptionThreshold: 3000, requiresStateLicense: true, disclosureRequirements: ["APR disclosure"], notes: "No usury cap for loans >$3K by written agreement (Ga. Code §7-4-2); 7% is default legal rate" },
  ...
  KS: { state: "Kansas", abbreviation: "KS", maxInterestRate: 0.15, commercialExemption: true, commercialExemptionThreshold: 25000, requiresStateLicense: true, disclosureRequirements: ["APR disclosure"], notes: "15% general (Kan. Stat. §16-207); higher for supervised lenders; commercial >$25K exempt" },
  ...
  NJ: { state: "New Jersey", abbreviation: "NJ", maxInterestRate: 0.06, commercialExemption: true, commercialExemptionThreshold: 50000, requiresStateLicense: true, disclosureRequirements: ["APR disclosure"], notes: "6% civil usury cap (N.J. Stat. §31:1-1); 30% is criminal threshold; commercial >$50K exempt" },
  ...
  VA: { state: "Virginia", abbreviation: "VA", maxInterestRate: 0.12, commercialExemption: true, commercialExemptionThreshold: 5000, requiresStateLicense: true, disclosureRequirements: ["APR disclosure"], notes: "12% legal (Va. Code §6.2-303); business loans >$5K exempt" },
