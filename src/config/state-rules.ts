...
const STATE_RULES_MAP: Record<string, StateRule> = {
  ...
  // AR: 17% constitutional cap. NOTE: Pending HB 1234 may raise to 20% effective July 2026.
  ...
  // Idaho has no general usury statute for written agreements; 12% applies only to oral/implied contracts (Idaho Code §28-22-104)
  ID: { state: "Idaho", abbreviation: "ID", maxInterestRate: 0.12, commercialExemption: true, commercialExemptionThreshold: 0, requiresStateLicense: false, disclosureRequirements: [], notes: "No general usury statute for written agreements; 12% applies only to oral/implied contracts (Idaho Code §28-22-104). For written commercial agreements, parties may agree to any rate." },
  ...
  // NY: Criminal usury 25%. Civil usury exemption threshold: $2.5M (may increase per Banking Law amendment).
  ...
  // TX: 28% commercial ceiling per TX Finance Code §303.009 weekly ceiling formula.
